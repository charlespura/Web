...
<body class="flex">
  ...
  <div id="sidebar" class="bg-gray-800 text-white w-64 transition-all duration-300 h-screen flex flex-col">
    ...
    <nav class="flex-1 px-2 py-4 space-y-2">
      ...
      <a href="/web/hr3/employee/employee.php"
         class="flex items-center gap-3 px-3 py-2 rounded hover:bg-gray-700 <?php echo ($currentPage == '/web/hr3/employee/employee.php') ? 'bg-gray-700 text-white' : ''; ?>">
      ...
      <a href="/web/hr3/shift/assignShift.php"
         class="flex items-center gap-3 px-3 py-2 rounded hover:bg-gray-700 <?php echo ($currentPage == '/web/hr3/shift/assignShift.php') ? 'bg-gray-700 text-white' : ''; ?>">
      ...
      <a href="/web/hr3/leave/leave.php"
         class="flex items-center gap-3 px-3 py-2 rounded hover:bg-gray-700 <?php echo ($currentPage == '/web/hr3/leave/leave.php') ? 'bg-gray-700 text-white' : ''; ?>">
